<?php 	
	...
	if($user->data['username']!='Anonymous' && $level == 16)
	{
?>
<html>
<head>
...
<body>
	...
	<form id="answer-form" action="process.php" method="post">
		<input type="text" name="answer" /> <input type="submit" value="submit" name="submit12" />
	</form>
</body>
<!-- reminded and wondering of what we are on the other 364 -->
</html>
<?php
$_GET['l']=100;
	}
