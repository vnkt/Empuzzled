<?php 	
	...
	if($user->data['username']!='Anonymous' && $level == 9)
	{
?>
<html>
<head>
...
<body>
	...
	<center>
		<br/>
		<p><img src="promise.jpg"  alt="" /></p>
	</center>
	<br>
	<form id="answer-form" action="process.php" method="post">
		<input type="text" name="answer" /> <input type="submit" value="submit" name="submit6" />
	</form>
</body>
<!-- Every year, a king rises -->
</html>
<?php
$_GET['l']=100;
	}
