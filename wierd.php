<?php 	
	...
	if($user->data['username']!='Anonymous' && $level == 15)
	{
?>
<html>
<head>
...
<body>
	...
	<center>
		<br/>
		<p><img src="captain.jpg"  alt="" /></p>
	</center>	
	<br>
	<form id="answer-form" action="process.php" method="post">
		<input type="text" name="answer" /> <input type="submit" value="submit" name="submit11" />
	</form>
<!-- the other , that got lost -->
</html>
<?php
$_GET['l']=100;
	}
