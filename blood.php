<?php 	
	...
	if($user->data['username']!='Anonymous' && $level == 21)
	{
?>
<html>
<head>
...
<body>
	...
	<center>
		<br/>
		<p><img src="bydesign.jpg"  alt="" /></p>
	</center>	
	<br>
	<form id="answer-form" action="process.php" method="post">
		<input type="text" name="answer" /> <input type="submit" value="submit" name="submit17" />
	</form>
</body>
<!-- As the night begins to chill, he begins to kill... -->
</html>
<?php
$_GET['l']=100;
	}
